...
if (isset($_POST['no'])) {
    ...
    $sks = $_POST['sks'];
    $waktu = $_POST['waktu'];
    $sql = "UPDATE krs SET NO='$no',KODE='$kode', NAMA_MATKUL='$nama_matkul', KELAS='$kelas', SKS='$sks', WAKTU='$waktu' WHERE NO=$no";
                ...
                <div class="card-body">
                  ...
                  ?>
                    <form action="updatekrs.php" method="POST">
                      <table id="update data" class="table table-bordered">
                        <thead>
                        ...
                        <tbody>
                          ...
                          <td>
                            <div>
                              <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $user_data['KODE']; ?>">
                            </div>
                          </td>
                          <td>
                            <div>
                              <input type="text" class="form-control" id="nama_matkul" name="nama_matkul" value="<?php echo $user_data['NAMA_MATKUL']; ?>">
                            </div>
                          </td>
                          <td>
                            <div>
                          ...
                          <td>
                            <div>
                              <input type="text" class="form-control" id="waktu" name="waktu" value="<?php echo $user_data['WAKTU']; ?>">
                            </div>
                          </td>
                          <td>
